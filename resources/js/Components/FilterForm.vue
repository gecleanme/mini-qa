<template>
    <div class="flex flex-col justify-center items-center mt-6 mb-6 md:w-75 ">
        <form class="flex flex-col items-center w-full px-4 py-8 rounded-lg shadow-md bg-gray-100 sm:w-3/4 md:w-75" @submit.prevent="filter">
            <div class="flex flex-wrap gap-2 mb-8">
                <div class="flex flex-nowrap items-center gap-2">
                    <select
                        class="w-28 px-3 py-2 text-gray-700 border
                    ...
                    <select class="w-28 px-3 py-2 text-gray-700 border
                    ...
                    <input type="text" class="w-28 px-3 py-2 text-gray-700 border border-gray-400
                ...
                <button type="submit" class="px-4 py-2 text-white bg-black rounded-md focus:outline-none hover:bg-gray-900">Filter</button>
                <button type="reset" class="px-4 py-2 text-black bg-gray-200 rounded-md focus:outline-none hover:bg-gray-300" @click="clear">Clear</button>
            </div>
        </form>
    </div>
