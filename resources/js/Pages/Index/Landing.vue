<template>
    <body class="h-screen">
        <div class="ml-4">
            <div class="chat chat-start mt-6 mb-6">
                ...
                <div class="chat-bubble bg-gray-200 text-black">
                    Hi {{ $page.props.user.name }}, <br />Hoping you'll be at
                    your most productive today ;)
                </div>
            </div>
        </div>
        ...
        <div class="mx-auto w-fit">
            <div
                class="stats stats-vertical lg:stats-horizontal shadow shadow-lg mb-8"
            >
                <div class="stat">
        ...
        <div class="card w-96 bg-base-100 shadow-xl w-80 flex mx-auto mt-6">
            <div class="card-body p-6">
                ...
                <blockquote
                    v-if="quote"
                    class="text-2xl text-black font-italic"
                >
                    {{ quote }}
                </blockquote>
