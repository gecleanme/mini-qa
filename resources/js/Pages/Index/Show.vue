        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
            ...
            >
                <div class="w-full sm:p-4 px-4 mb-6">
                    ...
                    <div class="leading-relaxed">{{ issue.description }}</div>
                </div>
            ...
            <div
                v-if="issue.attachments?.includes('.mp4')"
            ...
            <div
                v-else-if="
                    !issue.attachments?.includes('.mp4') &&
            ...
            <div
                v-else
                class="justify-content-center mb-6 mx-auto my-auto px-4 sm:p-4 text-center w-1/2"
            >
